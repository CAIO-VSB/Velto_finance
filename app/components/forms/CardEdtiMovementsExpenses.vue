        ...
        <v-card  rounded="xl" elevation="5">
          ...
          <v-card-text>
            ...
            <v-col
              cols="12" md="6" sm="12"
            >
            <CurrencyInput prepend-inner-icon="mdi-cash"  input-color="#C62828" base-color="#C62828" color="#C62828" :rules="currencyRules"  autocomplete="off" label="Valor*" v-model="props.draft.value_transaction" variant="solo-filled"/>
            </v-col>
